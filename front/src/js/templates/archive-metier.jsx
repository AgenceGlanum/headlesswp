...
const ArchiveMetierTemplate = ({ data, pageContext: { nextPagePath, previousPagePath } }) => {
...
export default ArchiveMetierTemplate

export const pageQuery = graphql`
    query WordPressPostArchive($postsPerPage: Int!, $offset: Int!) {
        posts: allWpMetier(sort: { date: DESC }, limit: $postsPerPage, skip: $offset) {
            nodes {
                excerpt
                uri
