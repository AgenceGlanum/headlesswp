...
/**
 * Fork & edit from https://github.com/vinkla/headache
 */

/*
 * Plugin Name: Headache
 * Description: An easy-to-swallow painkiller plugin for WordPress.
 * Author: Vincent Klaiber, Quentin LD
 * Author URI: https://github.com/quentin-glanum
 * Version: 1.0
 */
 ...
 */
function headache_disable_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'headache_disable_dashboard_widgets', 999);

/*
 * ================================
 *  Disable useless admin toolbar node
 */
function headache_remove_toolbar_node($wp_admin_bar) {
...
add_action('admin_bar_menu', 'headache_remove_toolbar_node', 999);
